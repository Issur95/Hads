...
from app.views import resultsSinLogIncorret
...
urlpatterns = [
    ...
    url(r'^(?P<question_id>\d+)/results/correct$', app.views.resultsSinLogCorrect, name='correct'),
    url(r'^(?P<question_id>\d+)/results/incorrect$', app.views.resultsSinLogIncorret, name='incorrect'),
    url(r'^polls2/', app.views.index2, name='index2'),
